...
library Players {
  ...
  function getLevel(IStore _store, bytes32 key) internal view returns (string memory level) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function setLevel(bytes32 key, string memory level) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 1, bytes((level)));
  }

  /** Set level (using the specified store) */
  function setLevel(IStore _store, bytes32 key, string memory level) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));

    _store.setField(_tableId, _keyTuple, 1, bytes((level)));
  }

  /** Get the length of level */
  ...
  /** Get the length of level (using the specified store) */
  function lengthLevel(IStore _store, bytes32 key) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Get an item of level (unchecked, returns invalid data if index overflows) */
  ...
  /** Get an item of level (using the specified store) (unchecked, returns invalid data if index overflows) */
  function getItemLevel(IStore _store, bytes32 key, uint256 _index) internal view returns (string memory) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Push a slice to level (using the specified store) */
  function pushLevel(IStore _store, bytes32 key, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Pop a slice from level (using the specified store) */
  function popLevel(IStore _store, bytes32 key) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Update a slice of level at `_index` */
  ...
  /** Update a slice of level (using the specified store) at `_index` */
  function updateLevel(IStore _store, bytes32 key, uint256 _index, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function set(bytes32 key, string memory name, string memory level) internal {
    bytes memory _data = encode(name, level);
  ...
  function set(IStore _store, bytes32 key, string memory name, string memory level) internal {
    bytes memory _data = encode(name, level);
  ...
  function set(bytes32 key, PlayersData memory _table) internal {
    set(key, _table.name, _table.level);
  }

  /** Set the full data using the data struct (using the specified store) */
  function set(IStore _store, bytes32 key, PlayersData memory _table) internal {
    set(_store, key, _table.name, _table.level);
  }

  /** Decode the tightly packed blob using this table's schema */
  function decode(bytes memory _blob) internal view returns (PlayersData memory _table) {
    ...
    if (_blob.length > 0) {
      ...
      _table.level = (string(SliceLib.getSubslice(_blob, _start, _end).toBytes()));
    }
  }

  /** Tightly pack full data using this table's schema */
  function encode(string memory name, string memory level) internal view returns (bytes memory) {
    uint40[] memory _counters = new uint40[](2);
    _counters[0] = uint40(bytes(name).length);
    _counters[1] = uint40(bytes(level).length);
    PackedCounter _encodedLengths = PackedCounterLib.pack(_counters);

    return abi.encodePacked(_encodedLengths.unwrap(), bytes((name)), bytes((level)));
  }
